...
public class TestSimpleOomage {
    ...
    public void testHashCodePerfect() {
        ...
        SimpleOomage ooA1 = new SimpleOomage(5, 5, 5);
        SimpleOomage ooA2 = new SimpleOomage(0, 15, 0);
        SimpleOomage ooA3 = new SimpleOomage(0, 0, 15);
        SimpleOomage ooA4 = new SimpleOomage(255, 255, 255);

        assertEquals(ooA.hashCode(), ooA1.hashCode());
